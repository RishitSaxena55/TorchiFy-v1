...
class CNN(object):
    ...
    def __init__(self, input_width, num_input_channels, num_channels, kernel_sizes, strides,
                 ...
                 linear_weight_init_fn, criterion, lr, in_channels=None):
        """
        ...
        for i in range(self.nlayers):
            if i == 0:
                self.convolutional_layers.append(Conv1d(in_channels=num_input_channels,
        ...
        self.linear_layer = Linear(in_features= width*num_channels[-1], out_features=num_linear_neurons)
